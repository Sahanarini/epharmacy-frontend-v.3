...
//     { name: "650mg", inStock: true },
//     { name: "1000mg", inStock: true },
//   ],
//   description:
//     'The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: "Black". Need to add an extra pop of color to your outfit? Our white tee has you covered.',
//   highlights: [
//     "Expires on or after : Jun-25",
//   ],
//   disclaimer:
//     'While we strive to provide complete, accurate, and expert-reviewed content on our Platform, we make no warranties or representations and disclaim all responsibility and liability for the completeness, accuracy, or reliability of the aforementioned content. The content on our platform is for informative purposes only, and may not cover all clinical/non-clinical aspects. Reliance on any information and subsequent action or inaction is solely at the users risk, and we do not assume any responsibility for the same. The content on the Platform should not be considered or used as a substitute for professional and qualified medical advice. Please consult your doctor for any query pertaining to medicines, tests and/or diseases, as we support, and do not replace the doctor-patient relationship.',
// };
...
//                     <h3 className="text-sm font-medium text-gray-900">Dose</h3>
//                   </div>
...
//               <div className="mt-10">
//                 <h2 className="text-sm font-medium text-gray-900">disclaimer</h2>
...
const product = {
  ...
  colors: [
    { name: "", class: "bg-white", selectedClass: "ring-gray-400" },
    { name: "", class: "bg-gray-200", selectedClass: "ring-gray-400" },
    { name: "", class: "bg-gray-900", selectedClass: "ring-gray-900" },
  ],
  sizes: [
    { name: "500mg", inStock: true },
    { name: "650mg", inStock: true },
